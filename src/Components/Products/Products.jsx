  ...
  return (
    <div id="products">
      ...
      <div className='product'>
        <img src={basmati}alt="" />
        <h3> Basmati Rice</h3>
        <p>Experience the exquisite aroma and delicate flavor of our premium Basmati rice, cultivated and processed with care at Sri Amman Rice Mill. Our Basmati rice features long, slender grains that cook up fluffy and separate, perfect for creating aromatic biryanis, flavorful pilafs, and mouthwatering rice dishes. </p>
      </div>
      <div className='product'>
        <img src={seerarice} alt="" style={{width:'95%'}}/>
        <h3 style={{marginLeft:'90px'}}>Seeraga Samba Rice</h3>
        <p>Elevate your culinary creations with the distinctive taste and superior quality of Seeraga Samba rice, meticulously sourced and processed at Sri Amman Rice Mill. Known for its tiny, pearl-like grains and unique fragrance, Seeraga Samba rice adds a delightful touch to biryanis, pulaos, and traditional South Indian dishes. Our Seeraga Samba rice is carefully aged to enhance its natural aroma and flavor, ensuring a rich and satisfying dining experience.</p>
      </div>
      <div className='product'>
        <img src={idli}alt="" style={{width:'103%'}}/>
        <h3>Ponni Kuranai Rice</h3>
        <p>Elevate your dining experience with the exceptional quality and distinct flavor of Ponni Kuranai rice, meticulously grown and processed at Sri Amman Rice Mill. Characterized by its medium-sized grains and subtle aroma, Ponni Kuranai rice is a versatile choice for a variety of culinary delights. Our Ponni Kuranai rice undergoes careful processing to preserve its natural taste and nutritional value, making it an ideal choice for health-conscious individuals.</p>
      </div>
      </div>
      <div className='products'>
      <div className='product'>
